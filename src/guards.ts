import { ErrorResponse, FASTFOX_ERROR_CODES_BY_KEY } from './interfaces';

export const isFastFoxErrorResponse = (
  response: unknown,
 ...
 */
export const isFastFoxErrorResponseStrict = (
  response: unknown,
): response is ErrorResponse => {
  if (typeof response !== 'object' || response === null) {
    return false;
  ...
  return (
    ...
    typeof name === 'string' &&
    name in FASTFOX_ERROR_CODES_BY_KEY
  );
};
